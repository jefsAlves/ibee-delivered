create table tb_city (id bigint not null auto_increment, name varchar(50) not null, state_id bigint not null, primary key (id)) engine=InnoDB;

create table tb_group (id bigint not null auto_increment, name varchar(50), primary key (id)) engine=InnoDB;
...
create table tb_permissions (id bigint not null auto_increment, description varchar(50), primary key (id)) engine=InnoDB;

create table tb_products (id bigint not null auto_increment, active bit not null, description varchar(50) not null, price decimal(19,2) not null, restaurant_id bigint, primary key (id)) engine=InnoDB;

create table tb_restaurant (id bigint not null auto_increment, address_cep varchar(50), address_complement varchar(50), address_neighborhood varchar(50), address_number varchar(50), address_street varchar(50), create_date datetime not null, freigth_rate decimal(19,2) not null, name varchar(50) not null, open bit, active_status bit, update_date datetime not null, kitchen_id bigint, primary key (id)) engine=InnoDB;
...
create table tb_state (id bigint not null auto_increment, name varchar(50) not null, primary key (id)) engine=InnoDB;

create table tb_user_group (user_id bigint not null, group_id bigint not null, primary key (user_id, group_id)) engine=InnoDB;

create table tb_users (id bigint not null auto_increment, create_date datetime not null, password varchar(50) not null, update_date datetime not null, user varchar(50) not null, primary key (id)) engine=InnoDB;
