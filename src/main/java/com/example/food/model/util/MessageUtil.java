...
public class MessageUtil {
	...
	public static final String CITY_ALREADY_EXIST = "This city already exists!";
	public static final String CITY_NOT_EXIST = "This city not exist!";
	...
	public static final String CANNOT_BE_ALTER_STATUS = "Cannot be alter status";
